  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-accent text-primary-foreground font-semibold hover:opacity-90 hover:scale-105 shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40",
        heroOutline: "border-2 border-accent/50 bg-transparent text-foreground hover:bg-accent/10 hover:border-accent hover:shadow-lg hover:shadow-accent/20",
        glow: "bg-primary text-primary-foreground glow-primary hover:opacity-90",
        accent: "bg-accent text-accent-foreground font-semibold hover:bg-accent/90 hover:shadow-lg hover:shadow-accent/25",
      },
      size: {
